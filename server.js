    ...
    db.query('SELECT * FROM role', (err, roles) => {
        db.query('SELECT * FROM employee', (err, managers) => {
            inquirer.prompt([
                ...
                let chosenRole = roles.find(role => role.id === data.roleID)
                let chosenManager = managers.find(manager => manager.id === data.managerID)
    ...
    db.query('SELECT * FROM employee', (err, employees) => {
        db.query('SELECT * FROM role', (err, roles) => {
            inquirer.prompt([
                ...
                let chosenEmployee = employees.find(employee => employee.id === data.employee)
                let chosenRole = roles.find(role => role.id === data.role)
